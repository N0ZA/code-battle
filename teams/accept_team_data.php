...
if ($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $hackathon='276';
    $school='oos'; //column to be deleted? Cuz schl is individually asked for members as well
    ...
    if ($_SESSION['noMembers'] > $maxP){
        ...
        $query="INSERT INTO team_data(H_id,C_id,TName,TMembers,TSchool) VALUES (:hackathon,:category,:teamName,:noMembers,:school);";
